...
void screen()
{
	...
	drawstring(250,450,"CODERS");
	drawstring(75,500,"Game Name:");
	drawstring(250,500,"Bricks Breaker");
	drawstring(75,400,"By:");
	drawstring(50,350,"TEAM CODERS");
	drawstring(150,250,"GUIDE:");
	drawstring(150,200,"SRINIVAS MURTHY");
	drawstring(150,60,"Academic Year : 2024-25");
...
void nextscreen()
{
	...
	drawstring(100,400,"press D to move right side");
